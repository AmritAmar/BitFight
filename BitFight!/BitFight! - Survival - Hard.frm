...
Begin VB.Form frmSurvivalHard 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "BitFight! - Survival - Hard"
   ClientHeight    =   8400
   ClientLeft      =   1092
   ClientTop       =   1572
   ClientWidth     =   17040
   Icon            =   "BitFight! - Survival - Hard.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "BitFight! - Survival - Hard.frx":058A
   ScaleHeight     =   8400
   ScaleWidth      =   17040
   ...
   Begin VB.Timer timGameMechanics 
      ...
      Top             =   120
   End
   Begin VB.Timer timSurvivalHard 
      Interval        =   1
      Left            =   720
      Top             =   120
   End
   ...
   Begin VB.Image Explosion1 
      Height          =   996
      Left            =   5280
      Picture         =   "BitFight! - Survival - Hard.frx":1F204
      Stretch         =   -1  'True
      Top             =   960
      Visible         =   0   'False
      Width           =   996
   ...
   Begin VB.Image TopFire1 
      Height          =   300
      Left            =   6840
      Picture         =   "BitFight! - Survival - Hard.frx":1F69B
      Stretch         =   -1  'True
      Top             =   960
      Width           =   300
   End
   ...
   Begin VB.Image RightFire1 
      Height          =   300
      Left            =   7200
      Picture         =   "BitFight! - Survival - Hard.frx":1FAF8
      Stretch         =   -1  'True
      Top             =   1320
      Width           =   300
   End
   Begin VB.Image DownFire1 
      Height          =   300
      Left            =   6840
      Picture         =   "BitFight! - Survival - Hard.frx":1FEEF
      Stretch         =   -1  'True
      Top             =   1680
      Width           =   300
   End
   Begin VB.Image LeftFire1 
      Height          =   300
      Left            =   6480
      Picture         =   "BitFight! - Survival - Hard.frx":202D7
      Stretch         =   -1  'True
      Top             =   1320
      Width           =   300
   End
   ...
   End
End
Attribute VB_Name = "frmSurvivalHard"
...
Private Sub Form_Load()
    ...
    txtSystemLog.Text = " - LOG INITIALIZED - " _
                            ...
                            + vbNewLine _
                            + vbNewLine _
                            + ">>> OBJECTIVE: Avoid Enemies and Warp Mines, Get a 12 Point Multiplier, and Survive until 2000 Points are Obtained..." _
                            + vbNewLine _
                            + vbNewLine _
    ...
    If PowerUpBit.Visible = True Then
        ...
        ElseIf (PowerUpBitNumber) = 14 Or (PowerUpBitNumber) = 19 Then 'Checks ID of Power Up (LEVEL MODIFIER)
            ...
            If Abs(UserBitX - PowerUpBitX) < 300 And Abs(UserBitY - PowerUpBitY) < 300 Then
                ...
                Call WallBitPosition(WallNumber, 4, 0)
...
Private Sub timPowerUpResultant_Timer()
    ...
    If isWall = True Then 'if there is a Wall
        ...
        frmSurvivalHard.Refresh 'Refreshes Form
...
Private Sub timSurvivalHard_Timer()
    
    lblScore.Caption = TotalPoints 'Sets Score in UI
    
    If (TotalPoints > 1999) And (PointMultiplier > 11) Then 'Checks if Player has achieved the necessary win conditions.
        ...
        lblGameOver.Caption = "You have beaten Survival: Hard! But do you have what it takes to make it to the Next Level?"
