...
Begin VB.Form frmSurvivalEasy 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "BitFight! - Survival - Easy"
   ClientHeight    =   8376
   ClientLeft      =   36
   ClientTop       =   384
   ClientWidth     =   17028
   Icon            =   "BitFight! - Survival - Easy.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "BitFight! - Survival - Easy.frx":058A
   ScaleHeight     =   8376
   ScaleWidth      =   17028
   ...
   Begin VB.Timer timGameMechanics 
      ...
      Top             =   120
   End
   Begin VB.Timer timSurvivalEasy 
      Interval        =   1
      Left            =   720
      Top             =   120
   End
   ...
   Begin VB.Image Explosion1 
      Height          =   996
      Left            =   5280
      Picture         =   "BitFight! - Survival - Easy.frx":7A0EC
      Stretch         =   -1  'True
      Top             =   360
      Visible         =   0   'False
      Width           =   996
   ...
   Begin VB.Image RightFire1 
      Height          =   300
      Left            =   7320
      Picture         =   "BitFight! - Survival - Easy.frx":7A583
      Stretch         =   -1  'True
      Top             =   720
      Width           =   300
   End
   Begin VB.Image DownFire1 
      Height          =   300
      Left            =   6960
      Picture         =   "BitFight! - Survival - Easy.frx":7A97A
      Stretch         =   -1  'True
      Top             =   1080
      Width           =   300
   End
   Begin VB.Image LeftFire1 
      Height          =   300
      Left            =   6600
      Picture         =   "BitFight! - Survival - Easy.frx":7AD62
      Stretch         =   -1  'True
      Top             =   720
      Width           =   300
   End
   Begin VB.Image TopFire1 
      Height          =   300
      Left            =   6960
      Picture         =   "BitFight! - Survival - Easy.frx":7B1A6
      Stretch         =   -1  'True
      Top             =   360
      Width           =   300
   End
   ...
   End
End
Attribute VB_Name = "frmSurvivalEasy"
...
Private Sub Form_Load()
    ...
    txtSystemLog.Text = " - LOG INITIALIZED - " _
                            ...
                            + vbNewLine _
                            + vbNewLine _
                            + ">>> OBJECTIVE: Avoid Enemies, Get a 4 Point Multiplier, and Survive until 1200 Points are Obtained..." _
                            + vbNewLine _
                            + vbNewLine _
    ...
    If PowerUpBit.Visible = True Then
        ...
        ElseIf (PowerUpBitNumber) = 14 Or (PowerUpBitNumber) = 19 Then 'Checks ID of Power Up (LEVEL MODIFIER)
            ...
            If Abs(UserBitX - PowerUpBitX) < 300 And Abs(UserBitY - PowerUpBitY) < 300 Then
                ...
                Call WallBitPosition(WallNumber, 2, 0)
...
Private Sub timPowerUpResultant_Timer()
    ...
    If isWall = True Then 'if there is a Wall
        ...
        frmSurvivalEasy.Refresh 'Refreshes Form
...
Private Sub timSurvivalEasy_Timer()
    
    lblScore.Caption = TotalPoints 'Sets Score in UI
    
    If (TotalPoints > 1199) And (PointMultiplier > 3) Then 'Checks if Player has achieved the necessary win conditions.
        ...
        lblGameOver.Caption = "You have beaten Survival: Easy! But do you have what it takes to make it to the Next Level?"
