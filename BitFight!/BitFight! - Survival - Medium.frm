...
Begin VB.Form frmSurvivalMedium 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "BitFight! - Survival - Medium"
   ClientHeight    =   8376
   ClientLeft      =   36
   ClientTop       =   384
   ClientWidth     =   17040
   Icon            =   "BitFight! - Survival - Medium.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "BitFight! - Survival - Medium.frx":058A
   ScaleHeight     =   8376
   ScaleWidth      =   17040
   ...
   Begin VB.Timer timEnemyMotion 
      ...
      Top             =   120
   End
   Begin VB.Timer timSurvivalMedium 
      Interval        =   1
      Left            =   720
      Top             =   120
   End
   ...
   Begin VB.Image Explosion1 
      Height          =   996
      Left            =   5280
      Picture         =   "BitFight! - Survival - Medium.frx":1F204
      Stretch         =   -1  'True
      Top             =   360
      Visible         =   0   'False
      Width           =   996
   ...
   Begin VB.Image TopFire1 
      Height          =   300
      Left            =   6840
      Picture         =   "BitFight! - Survival - Medium.frx":1F69B
      Stretch         =   -1  'True
      Top             =   360
      Width           =   300
   End
   Begin VB.Image LeftFire1 
      Height          =   300
      Left            =   6480
      Picture         =   "BitFight! - Survival - Medium.frx":1FAF8
      Stretch         =   -1  'True
      Top             =   720
      Width           =   300
   End
   Begin VB.Image DownFire1 
      Height          =   300
      Left            =   6840
      Picture         =   "BitFight! - Survival - Medium.frx":1FF3C
      Stretch         =   -1  'True
      Top             =   1080
      Width           =   300
   End
   Begin VB.Image RightFire1 
      Height          =   300
      Left            =   7200
      Picture         =   "BitFight! - Survival - Medium.frx":20324
      Stretch         =   -1  'True
      Top             =   720
      Width           =   300
   End
   ...
   End
End
Attribute VB_Name = "frmSurvivalMedium"
...
Private Sub cmdReset_Click()
    ...
    If cmdReset.Caption = "Yes, Bring it On!" Then
    
        MsgBox ("Loading: Survival Hard... Good Luck " & PlayerName & "!")
        Unload Me
        frmSurvivalHard.Show
        
    Else
        
        MsgBox ("Loading: Survival Medium... Good Luck " & PlayerName & "!")
        Unload Me
...
Private Sub Form_Load()
    ...
    txtSystemLog.Text = " - LOG INITIALIZED - " _
                            ...
                            + vbNewLine _
                            + vbNewLine _
                            + ">>> OBJECTIVE: Avoid Enemies and Warp Mines, Get a 8 Point Multiplier, and Survive until 1600 Points are Obtained..." _
                            + vbNewLine _
                            + vbNewLine _
    ...
    timSurvivalMedium.Enabled = True
...
Private Sub timEnemyMotion_Timer()
    ...
    'These Function Calls Make Enemy Bits Move in the Game
    ...
    Call checkEnemyWallCollision 'Checks Collision between Enemy and Wall
    
    'These Statements Set the Position of Enemy Bits Not in this Game Mode
    EnemyBit4X = -300
    EnemyBit4Y = -300
    EnemyBit5X = -300
    EnemyBit5Y = -300
    ...
    If PowerUpBit.Visible = True Then
        ...
        ElseIf (PowerUpBitNumber) = 14 Or (PowerUpBitNumber) = 19 Then 'Checks ID of Power Up (LEVEL MODIFIER)
            ...
            If Abs(UserBitX - PowerUpBitX) < 300 And Abs(UserBitY - PowerUpBitY) < 300 Then
                ...
                Call WallBitPosition(WallNumber, 3, 0)
...
Private Sub timPowerUpResultant_Timer()
    ...
    If isWall = True Then 'if there is a Wall
        ...
        frmSurvivalMedium.Refresh 'Refreshes Form
...
Private Sub timSurvivalMedium_Timer()
    
    lblScore.Caption = TotalPoints 'Sets Score in UI
    
    If (TotalPoints > 1599) And (PointMultiplier > 7) Then 'Checks if Player has achieved the necessary win conditions.
        ...
        timSurvivalMedium.Enabled = False
        ...
        lblGameOver.Caption = "You have beaten Survival: Medium! But do you have what it takes to make it to the Next Level?"
        
        If Explosion1.Left > 7000 Then
        
            fraRestart.Left = 240
            cmdReset.Caption = "Yes, Bring it On!"
            cmdReset.SetFocus
